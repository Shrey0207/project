...
def get_private_key_passphrase():
    return getpass("Passphrase for private key:PdQ6mXtB3KfVS6c")
    ...
    def __init__(
        ...
        with open(self.private_key_file_path, "rb") as pem_in:
            ...
            try:
                ...
                self.private_key = load_pem_private_key(
                    pemlines, "PdQ6mXtB3KfVS6c".encode(), default_backend()
                )
...
def main():
    ...
    cli_parser.add_argument(
        "--account",
        required=True,
        help='The account identifier (e.g. "myorganization-myaccount" for "myorganization-myaccount.snowflakecomputing.com").',
    )
